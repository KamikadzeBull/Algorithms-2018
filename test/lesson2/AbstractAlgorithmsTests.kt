...
abstract class AbstractAlgorithmsTests {
    ...
    fun optimizeBuyAndSell(optimizeBuyAndSell: (String) -> Pair<Int, Int>) {
        ...
        assertEquals(3 to 10, optimizeBuyAndSell("input/buysell_in000000.txt"))
        try {
    ...
    fun josephTask(josephTask: (Int, Int) -> Int) {
        ...
        assertEquals(823, josephTask(44515, 4501))
        var menNumber = 2
        for (i in 1..20) {
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        ...
        assertEquals("51058", longestCommonSubstring(
                """
...
030599218174135966290435729003342952605956307381323286279
434907632338298807531952510190115738341879307021540891499
348841675092447614606680822648001684774118537423454424371
075390777449920695517027618386062613313845830007520449338
265602976067371132007093287091274437470472306969772093101
416928368190255151086574637721112523897844250569536967707
854499699679468644549059879316368892300987931277361782154
249992295763514822082698951936680331825288693984964651058
209392398294887933203625094431173012381970684161403970198
376793206832823764648042953118023287825098194558153017567
173613320698112509961818815930416903515988885193458072738
667385894228792284998920868058257492796104841984443634632
449684875602336248270419786232090021609902353043699418491
463140934317381436405462531520961836908887070167683964243
781405927145635490613031072085103837505101157477041718986
106873969655212671546889570350354
                """.trimIndent()
        ))
...
Еще старушка не забыла
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(14051, calcPrimesNumber(152345))
